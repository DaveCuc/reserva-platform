    ...
    <MainLayout>
      ...
      <div className="max-w-5xl mx-auto flex md:items-center md:justify-center h-full p-6 mt-10">
        <div className="bg-white p-8 rounded-xl shadow-sm border border-brand-soft">
          <h1 className="text-2xl font-bold">Nombra tu evento</h1>
          <p className="text-sm text-brand-ink mt-2">
            ¿De qué tratará este evento? No te preocupes, puedes cambiar el título más tarde.
          </p>
          
          <form onSubmit={onSubmit} className="space-y-8 mt-8">
            <div className="space-y-2">
                <label className="text-sm font-medium leading-none">Título del evento</label>
                <Input
                    disabled={processing}
                    placeholder="Ej. 'Gira Universitaria de IA 2026'"
                    value={data.title}
