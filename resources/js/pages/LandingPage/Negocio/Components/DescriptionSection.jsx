    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className={`bg-white rounded-xl border shadow-sm p-6 md:p-8 ${hasPersonalContact ? 'lg:col-span-2' : 'lg:col-span-3'}`}>
                <h2 className="text-2xl font-semibold text-brand-text mb-6">Descripción</h2>
                {trade.descripcion_larga ? (
                    <div className="prose prose-sm md:prose-base max-w-none text-brand-ink">
            ...
            {hasPersonalContact && (
                <div className="bg-white rounded-xl border shadow-sm p-6 md:p-8 lg:col-span-1 h-fit">
                    <h2 className="text-2xl font-semibold text-brand-text mb-6">Contacto Personal</h2>
