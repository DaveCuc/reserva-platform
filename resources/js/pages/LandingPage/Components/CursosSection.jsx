...
export default function CursosSection() {
    return (
        <section className="py-20 mb-20 bg-brand-pale">
            <div className="container mx-auto px-4 text-center max-w-7xl">
                <h1 className="text-4xl font-bold text-brand-text">Únete a nuestra comunidad</h1>
                <p className="mt-4 text-brand-ink max-w-3xl mx-auto">
            ...
            <div className="container mx-auto px-4 mt-16 max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="bg-white p-8 rounded-lg shadow-lg flex flex-col items-center text-center">
                    <h2 className="text-2xl font-bold text-brand-text mb-4">Explora Nuestros Cursos</h2>
                    <p className="text-brand-ink mb-8 flex-grow">
                ...
                <div className="bg-white p-8 rounded-lg shadow-lg flex flex-col items-center text-center">
                    <h2 className="text-2xl font-bold text-brand-text mb-4">Date a Conocer</h2>
                    <p className="text-brand-ink mb-8 flex-grow">
